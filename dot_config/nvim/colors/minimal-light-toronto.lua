-- minimal-light-toronto.lua
-- Light version of minimal-dark-toronto colorscheme
...
vim.g.colors_name = 'minimal-light-toronto'
...
hi('@variable.member',     { fg = palette.class }) -- properties/fields use class color
