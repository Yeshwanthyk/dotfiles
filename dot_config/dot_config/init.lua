...
require('lazy').setup {
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>x'] = { name = '[D]iagnostic', _ = 'which_key_ignore' },
      }
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><space>', builtin.find_files, { desc = '[S]earch [N]eovim files' })
    end,
  },
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      require('luasnip.loaders.from_vscode').lazy_load { paths = { '~/.config/kickstart/snippets' } }
